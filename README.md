...
**AI proje rehberi (sıkı):** [`AI_PROJE_REHBERI.md`](./AI_PROJE_REHBERI.md) — kurallar, durum, AI/API haritası. Satış modeli: ücretsiz kayıt + ücretli paketler (paketsiz paneller kilitli; HT kayıt serbest). Denetim: [`docs/ROADMAP_DENETIM.md`](./docs/ROADMAP_DENETIM.md). Detay: `.cursor/skills/yeniform-*`.  
