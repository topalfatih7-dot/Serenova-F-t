...
5. Prerender: `SERVICE_PAGES` otomatik; diğerleri `STATIC_SHELLS` (ör. `/kalori-hesaplama`)
6. JSON-LD + iç link
7. `npm run build`
8. GSC URL Inspection

Yasak: sahte rating, şehir doorway, yeni Vercel `api/*.js`, tıbbi teşhis copy. Hamilelik sayfasında kilo verdirme/kalori açığı yok.
