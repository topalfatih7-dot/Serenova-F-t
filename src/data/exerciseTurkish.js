...
const PHRASE_MAP = [
  ...
  ['facial muscles', 'yüz kasları'],
  ['cardiovascular system', 'kardiyovasküler sistem'],
  ['interlaced fingers behind back', 'sırt arkasında kenetlenmiş parmaklar'],
  ['interlaced fingers', 'kenetlenmiş parmaklar'],
  ['interlaced back', 'kenetlenmiş sırt'],
  ['shoulder blade clock', 'kürek kemiği saati'],
  ['shoulder butterfly', 'omuz kelebeği'],
  ['shoulder circle', 'omuz çemberi'],
  ['shoulder rolls', 'omuz yuvarlama'],
  ['shoulder rotate', 'omuz rotasyonu'],
  ['shoulder shurg', 'omuz silkme'],
  ['shoulder shrug', 'omuz silkme'],
  ['scapular squeeze', 'kürek kemiği sıkma'],
  ['chest opener', 'göğüs açıcı'],
  ['deep breath', 'derin nefes'],
  ['forward fold', 'öne eğilme'],
  ['cat cow', 'kedi deve'],
  ['side to side', 'sağa sola'],
  ['up down', 'aşağı yukarı'],
  ['toe touch', 'parmak ucu dokunuş'],
  ['toe raise', 'parmak ucu kaldırma'],
  ['knee extension', 'diz ekstansiyonu'],
  ['leg swing', 'bacak savurma'],
  ['glute squeeze', 'kalça sıkma'],
  ['glute kickback', 'kalça geri itiş'],
  ['hamstring curl', 'arka bacak curl'],
  ['hip hinge', 'kalça menteşesi'],
  ['mini squats', 'mini squat'],
  ['mini squat', 'mini squat'],
  ['wide leg', 'geniş bacak'],
  ['single-leg balance', 'tek bacak denge'],
  ['single leg balance', 'tek bacak denge'],
  ['side leg raise', 'yan bacak kaldırma'],
  ['side leg stretch', 'yan bacak esnetme'],
  ['quad stretch', 'ön bacak esnetme'],
  ['palm of hands', 'avuç içi'],
  ['hands on desk', 'eller masada'],
  ['half bent', 'yarı eğik'],
  ['straight hands', 'düz kollar'],
  ['place jog running', 'yerinde koşu'],
  ['slightly jump squat', 'hafif zıplamalı squat'],
  ['self hug', 'kendine sarılma'],
  ['spine rocking', 'omurga sallama'],
  ['thoracic twist', 'göğüs omurgası burgu'],
  ['torso twist', 'gövde burgu'],
  ['torso stretch', 'gövde esnetme'],
  ['dynamic stretch', 'dinamik esnetme'],
  ['dynamic chest', 'dinamik göğüs'],
  ['eyes close', 'gözler kapalı'],
  ['fast leg', 'hızlı bacak'],
  ['both legs', 'iki bacak'],
  ['overhead arms', 'baş üstü kollar'],
  ['overhead hand', 'baş üstü el'],
  ['arms up down', 'kollar aşağı yukarı'],
  ['arms stretch', 'kol esnetme'],
  ['wrist stretch', 'bilek esnetme'],
  ['side stretch', 'yan esnetme'],
  ['back stretch', 'sırt esnetme'],
  ['leg stretch', 'bacak esnetme'],
  ['neck stretch', 'boyun esnetme'],
  ['neck lift', 'boyun kaldırma'],
  ['neck and back', 'boyun ve sırt'],
  ['push ups', 'şınav'],
  ['push up', 'şınav'],
  ...
  ['clock', 'saat'],
  ['blade', 'kemik'],
  ['interlaced', 'kenetlenmiş'],
  ['fingers', 'parmaklar'],
  ['behind', 'arkasında'],
  ['hips lift', 'kalça kaldırma'],
  ['standard', 'standart'],
  ['bent', 'eğik'],
]
