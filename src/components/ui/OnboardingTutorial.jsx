...
const STEPS = [
  ...
  },
  {
    ...
    title: 'Hareket videoları',
    subtitle: 'Programınızdaki egzersizler',
    description: 'Koçunuzun programındaki hareketlerin doğru yapılışını videodan izleyebilirsiniz. Takviminizdeki antrenmanı görüntülerken de ilgili videoları açabilirsiniz.',
    icon: Library,
