...
const THEME = {
  ...
  diet_reason:   { grad: 'from-sage-500 to-emerald-600', soft: 'bg-sage-50', ring: 'ring-sage-300', solid: 'bg-sage-500 border-sage-400 shadow-sage-500/25', chip: 'border-sage-400 bg-sage-50 text-sage-800 ring-sage-200', bar: 'bg-sage-500', text: 'text-sage-700' },
  diet_health:   { grad: 'from-rose-500 to-rose-600', soft: 'bg-rose-50', ring: 'ring-rose-300', solid: 'bg-rose-500 border-rose-400 shadow-rose-500/25', chip: 'border-rose-400 bg-rose-50 text-rose-800 ring-rose-200', bar: 'bg-rose-500', text: 'text-rose-700' },
  diet_family:   { grad: 'from-violet-500 to-indigo-600', soft: 'bg-violet-50', ring: 'ring-violet-300', solid: 'bg-violet-500 border-violet-400 shadow-violet-500/25', chip: 'border-violet-400 bg-violet-50 text-violet-800 ring-violet-200', bar: 'bg-violet-500', text: 'text-violet-700' },
  diet_lifestyle:{ grad: 'from-sky-500 to-blue-600', soft: 'bg-sky-50', ring: 'ring-sky-300', solid: 'bg-sky-500 border-sky-400 shadow-sky-500/25', chip: 'border-sky-400 bg-sky-50 text-sky-800 ring-sky-200', bar: 'bg-sky-500', text: 'text-sky-700' },
  diet_activity: { grad: 'from-amber-500 to-orange-600', soft: 'bg-amber-50', ring: 'ring-amber-300', solid: 'bg-amber-500 border-amber-400 shadow-amber-500/25', chip: 'border-amber-400 bg-amber-50 text-amber-800 ring-amber-200', bar: 'bg-amber-500', text: 'text-amber-700' },
  diet_nutrition:{ grad: 'from-sage-500 to-emerald-600', soft: 'bg-sage-50', ring: 'ring-sage-300', solid: 'bg-sage-500 border-sage-400 shadow-sage-500/25', chip: 'border-sage-400 bg-sage-50 text-sage-800 ring-sage-200', bar: 'bg-sage-500', text: 'text-sage-700' },
  diet_women:    { grad: 'from-pink-500 to-fuchsia-600', soft: 'bg-pink-50', ring: 'ring-pink-300', solid: 'bg-pink-500 border-pink-400 shadow-pink-500/25', chip: 'border-pink-400 bg-pink-50 text-pink-800 ring-pink-200', bar: 'bg-pink-500', text: 'text-pink-700' },
  diet_history:  { grad: 'from-teal-500 to-cyan-600', soft: 'bg-teal-50', ring: 'ring-teal-300', solid: 'bg-teal-500 border-teal-400 shadow-teal-500/25', chip: 'border-teal-400 bg-teal-50 text-teal-800 ring-teal-200', bar: 'bg-teal-500', text: 'text-teal-700' },
  diet_extra:    { grad: 'from-brand-500 to-brand-600', soft: 'bg-brand-50', ring: 'ring-brand-300', solid: 'bg-brand-500 border-brand-400 shadow-brand-500/25', chip: 'border-brand-400 bg-brand-50 text-brand-800 ring-brand-200', bar: 'bg-brand-500', text: 'text-brand-700' },
}
