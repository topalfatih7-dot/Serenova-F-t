import { BRAND_SOCIAL_LINKS } from '../../config/brand'
...
export default function FooterSocialLinks() {
  const links = BRAND_SOCIAL_LINKS.filter((item) => item.url)
          ...
          return (
            ...
            >
              ...
              <span className="min-w-0">
                ...
                {item.handle ? (
                  <span className="block text-xs text-cream-100/55">{item.handle}</span>
                ) : null}
              </span>
            </a>
          )
