...
const memberNav = [
  ...
  { to: '/schedule/coach', icon: Dumbbell, label: 'Koç Görüşmeleri' },
  { to: '/schedule/dietitian', icon: Apple, label: 'Diyetisyen Görüşmeleri' },
  { to: '/schedule/doctor', icon: Stethoscope, label: 'Doktor Görüşmeleri' },
