...
const EMPTY_FORM = {
  ...
  specialty: '', workDays: [1, 3, 5], workStart: '09:00', workEnd: '17:00',
}
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="font-display text-2xl font-bold text-cream-900">Koç & Diyetisyen Yönetimi</h1>
          <p className="mt-1 text-sm text-cream-800/60">{staff.length} kayıtlı uzman</p>
        </div>
